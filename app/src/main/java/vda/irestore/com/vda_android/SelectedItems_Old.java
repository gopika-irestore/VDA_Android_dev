...
public class SelectedItems_Old extends AppCompatActivity {
    ...
    private void loadSelectedScopesData(final String key, final String jsonKey)
    {
        ...
        try {
            ...
            mGridAdapter = new GridViewAdapter(SelectedItems_Old.this, R.layout.grid_single, mGridData_pole);
        ...
        mGridView_pole.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                ShowMetaDataDialog(SelectedItems_Old.this, item, position,key,jsonKey);

            }
        });
    }

    private void ShowMetaDataDialog(final Context mContext, final GridItem item, int position,final String key,String JsonKey) {

        gridTitle = item.getTitle();
        sharedPref = mContext.getSharedPreferences(mContext.getString(
                R.string.preference_file_key), Context.MODE_PRIVATE);

        final Dialog dialog = new Dialog(SelectedItems_Old.this,R.style.Theme_Dialog);
     ...
     //   dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
        ...
        comments.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                final BottomSheetDialog dialog2 = new BottomSheetDialog(SelectedItems_Old.this);
       ...
       /* final CustomList adapter = new CustomList(SelectedItems.this, web, imageId);
        ...
        arrayAdapter = new InspectionMetaDataAdapter(pole_inspectionData_list,SelectedItems_Old.this,listView);
        ...
        close.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String keyTosave = item.getTitle()+key;
                ...
                if(GlobalData.metadataPreferencesEditor!=null) {
                    GlobalData.metadataPreferencesEditor.remove(keyTosave).commit();
                    //             editor.putString("othersJSON_Modified",json);
                    GlobalData.metadataPreferencesEditor.putString(keyTosave, json);
