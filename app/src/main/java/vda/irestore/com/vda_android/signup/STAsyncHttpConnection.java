    ...
    protected String doInBackground(String... params) {
        ...
        try {
           ...
           // if (httpPostData != null) {
            ...
            Log.i("testing","statusCode===urlConnection"+urlConnection.getResponseMessage());
/*
                OutputStream writer =
           ...
           // }
            ...
            Log.i("testing","statusCode==="+statusCode);
            ...
            if (result != null) {
               ...
               // message = responseObject.get("Message").toString();
                 ...
                 if(!error)
                 {
                     ...
                     if (appContext.getClass().equals(Main3Activity.class)) {
                         ((Main3Activity) appContext).processWebServiceResponse();
                     }
                 }else
                {
                    message = responseObject.get("Message").toString();
